...
@Controller
public class M_StoreInfoController {
	...
	@RequestMapping(value="/m_storeInfo", method=RequestMethod.POST)
	...
	@RequestMapping(value="/m_storeInfoUpdate", method=RequestMethod.POST)
