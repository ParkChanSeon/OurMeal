...
<!-- 여기부터 게시판 뷰 -->
	<div class="wrapper">
		<h1>QNA 게시글 작성</h1>
			<br />
			<form action="qnaMemberWriteSuccess" method="post">
			    <table class="boardWrite">
				<tr>
					<th>제목</th>
					<td>
					    <input type="text" name="mqb_title" class="boardSubject" pattern="[ㄱ-ㅎ가-힣a-zA-z]{1,50}" title="50글자 이하로 작성하세요" required/>
					    <input type="hidden" name="member_id">
					</td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea name="mqb_content" class="boardContent" required></textarea></td>
				</tr>
			    </table><br />
