...
<body>
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4">
			<form action="${pageContext.request.contextPath}/idSearch" method="post">
				...
				<div>
					...
					<p class="w3-center">
						<button type="submit" id=findBtn class="w3-button w3-block w3-black w3-ripple w3-margin-top w3-round">일반 아이디 찾기</button>
